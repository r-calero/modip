...
--
-- Dumping data for table `assay_notification_types`
--

LOCK TABLES `assay_notification_types` WRITE;
/*!40000 ALTER TABLE `assay_notification_types` DISABLE KEYS */;
INSERT INTO `assay_notification_types` VALUES (1,'AssayInserted'),(2,'AssayProcessed'),(3,'AssayFailed');
/*!40000 ALTER TABLE `assay_notification_types` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `compound_notification_types`
--

LOCK TABLES `compound_notification_types` WRITE;
/*!40000 ALTER TABLE `compound_notification_types` DISABLE KEYS */;
INSERT INTO `compound_notification_types` VALUES (1,'CompoundInserted'),(2,'CompoundProcessed'),(3,'CompoundWarning'),(4,'CompoundFailed');
/*!40000 ALTER TABLE `compound_notification_types` ENABLE KEYS */;
UNLOCK TABLES;
