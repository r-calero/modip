...
download_server = DownloadServer.new(ARGV[0].to_i, ARGV[1].to_s , assays, compound_2d, compound_3d, pids)
#download_server = DownloadServer.new(0, "http://yeniffer:leeialo3@proxy.unah.edu.cu:3128" , assays, compound_2d, compound_3d, pids)
